...
<div class="fontAdmin">
	...
	<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="mt-3 mb-4">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item"><a href="<?= BASEURL . '/Admin_mhs'?>">Mahasiswa</a></li>
    ...
    <div class="row">
    	<div class="col-md-6">   
    		<?php foreach ($data['tampilMhs'] as $mhs) :?>  
				<form action="<?= BASEURL; ?>/Admin_mhs/editMhs/<?= $mhs['nim']; ?>" method="POST">
			        <div class="row"> 
			            <div class="col pb-3">
				...
				<?php endforeach; ?>
			        ...
			        <div class="row">
			        	<div class="col-md-12 text-end my-3">
			        		<a href="<?= BASEURL . '/Admin_mhs'?>" type="button" class="btn btn-secondary me-1 tombolEdit" data-bs-dismiss="modal">Kembali</a>
		  ...
		  <div class="modal-dialog modal-dialog-centered fontAdmin">
		    <div class="modal-content">
		      ...
		      <div class="modal-body my-2 text-center">
		        <a href="<?= BASEURL . '/Admin_mhs/edit'?>" class="btn btn-secondary me-1" data-bs-dismiss="modal">Batal</a>
